        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          {currentWishes.map((wish) => (
            ...
            >
              ...
              <h2 className="text-2xl font-sriracha font-bold text-seccolor text-center">{wish.name}</h2>
              <p className="text-lg text-seccolor font-sriracha text-center">“{wish.message}”</p>
            </div>
          ))}
        </div>
